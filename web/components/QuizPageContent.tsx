      ...
      <div className={`w-full transition-all duration-500 transform ${isFlipped ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4 pointer-events-none'}`}>
        <div className="mt-4 p-6 glass-card border-t-4 border-t-primary/50 flex flex-col gap-4 text-center">
          ...
          <div className="grid grid-cols-4 gap-3">
            <button onClick={() => handleNext(1)} className="py-3 rounded-lg bg-red-500/10 hover:bg-red-500/20 text-red-400 border border-red-500/20 font-medium transition-colors flex flex-col items-center">
              <span>Again</span>
              <span className="text-[10px] opacity-40 mt-0.5 font-mono">Press 1</span>
            </button>
            <button onClick={() => handleNext(3)} className="py-3 rounded-lg bg-orange-500/10 hover:bg-orange-500/20 text-orange-400 border border-orange-500/20 font-medium transition-colors flex flex-col items-center">
              <span>Hard</span>
              <span className="text-[10px] opacity-40 mt-0.5 font-mono">Press 2</span>
            </button>
            <button onClick={() => handleNext(4)} className="py-3 rounded-lg bg-green-500/10 hover:bg-green-500/20 text-green-400 border border-green-500/20 font-medium transition-colors flex flex-col items-center">
              <span>Good</span>
              <span className="text-[10px] opacity-40 mt-0.5 font-mono">Press 3</span>
            </button>
            <button onClick={() => handleNext(5)} className="py-3 rounded-lg bg-blue-500/10 hover:bg-blue-500/20 text-blue-400 border border-blue-500/20 font-medium transition-colors flex flex-col items-center">
              <span>Easy</span>
